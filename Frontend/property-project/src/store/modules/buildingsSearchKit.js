...
export default {
    ...
    mutations: {
        ...
        updateIsExtendedSearchActivated(state, value){
            state.isExtendedSearchActivated = (Boolean(value))
        }
    ...
    getters: {
        ...
        // isExtendedSearchActivated(state){
        //     return state.isExtendedSearchActivated
        // }
