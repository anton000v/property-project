...
from api import choices as choices
...
class NewBuilding(models.Model):
    ...
    administrative_district = models.ForeignKey(AdministrativeDistrict, on_delete=models.CASCADE,
                                                verbose_name="Административный район")
    ...
    number_of_apartments_in_house = models.PositiveSmallIntegerField(verbose_name=u"Кол-во квартир в доме",
                                                                     default=1)  #
    ...
    number_of_apartments_per_floor = models.PositiveSmallIntegerField(verbose_name=u"Кол-во квартир на этаже",
                                                                      default=1)
